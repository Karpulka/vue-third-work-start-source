...
onMounted(() => {
  // Фокусируем надиалоговом окне, чтобы сработала клавиша Esc без дополнительного клика на окне
  dialog.value.focus();
});
...
// Определяем, работаем мы над редактированием задачи или создаем новую
